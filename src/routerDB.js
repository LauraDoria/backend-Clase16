...
const router = Router()
const productControllersMariaDB = require('../DB/mariaDB/mariaDBProductControllers');
const cartControllersMariaDB = require('../DB/mariaDB/mariaDBCartControllers');
...
router.post('/products', (req, res) => {
    ...
    res.render('/cart/:id', () => {
        ...
        return {productQuantity: cartControllersMariaDB.getById(cartId).products.length}
    })
...
router.get('/cart/:id', (req, res) => {
    const cartId = parseInt(req.params.id)
    res.render('cart', {
        products: cartControllersMariaDB.getById(cartId).products,
        quantity: cartControllersMariaDB.getById(cartId).products.length
    })
    console.log('GET request succesful.')
})
...
router.delete('/cart/:id', (req, res) => {
    const cartId = parseInt(req.params.id)
    res.render('cart', () => {
        cartControllersMariaDB.empty(cartId)
...
router.delete('/cart/:id', (req, res) => {
    ...
    const productId = parseInt(req.body.id)
    res.render('cart', () => {
        cartControllersMariaDB.deleteProduct(cartId, productId)
        return {products: cartControllersMariaDB.getById(cartId).products}
    })
    console.log('DELETE request succesful.')
})
